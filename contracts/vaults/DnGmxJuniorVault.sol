...
import { DnGmxJuniorVaultStorage } from '../vaults/DnGmxJuniorVaultStorage.sol';
...
contract DnGmxJuniorVault is IDnGmxJuniorVault, ERC4626Upgradeable, OwnableUpgradeable, PausableUpgradeable {
    ...
    */
    ...
    //         state.dnUsdcDeposited += _convertAssetToAUsdc(uint256(borrowVal - state.dnUsdcDeposited)).toInt256();
    ...
    //         _convertAUsdcToAsset(uint256(state.dnUsdcDeposited - borrowVal));
    ...
    //     (uint256 btcTokenAmount, uint256 btcUsdcAmount, bool repayDebtBtc) = state.flashloanAmounts(
    //         address(state.wbtc),
    //         optimalBtcBorrow,
    //         currentBtcBorrow
    //     );
    //     (uint256 ethTokenAmount, uint256 ethUsdcAmount, bool repayDebtEth) = state.flashloanAmounts(
    //         address(state.weth),
    //         optimalEthBorrow,
    //         currentEthBorrow
    //     );
    ...
    // ) internal {
    //     // console.log('totalAssets()', totalAssets());
    //     (uint256 optimalBtcBorrow, uint256 optimalEthBorrow) = state.getOptimalBorrows(glpDeposited);
    //     // console.log('optimalBtcBorrow', optimalBtcBorrow);
    //     // console.log('optimalEthBorrow', optimalEthBorrow);

    //     uint256 optimalBorrowValue = state.getBorrowValue(optimalBtcBorrow, optimalEthBorrow);
    //     // console.log('optimalBorrowValue', optimalBorrowValue);

    //     uint256 usdcLiquidationThreshold = _getLiquidationThreshold(address(state.usdc));
    ...
    //         {
    //             (uint256 currentBtc, uint256 currentEth) = state.getCurrentBorrows();
    //             totalCurrentBorrowValue = state.getBorrowValue(currentBtc, currentEth);
    //         }
